...
const Dashboard = () => {
  ...
  // card component for 4 different stats in the dashboard
  ...
  return (
    <div className='px-4 pt-10 md:px-10 flex-1'>
        <Title title ="Admin Dashboard" subTitle="Monitor overall performance including total cars, revenue, bookings, and user activity"/>
      ...
      {/* div that contain both left and right */}
