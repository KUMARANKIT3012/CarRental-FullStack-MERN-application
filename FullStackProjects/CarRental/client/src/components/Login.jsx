...
// we will mount this component conditionally in App.jsx based on login state
// so that when user clicks on login button in navbar the login form appears
// NOTE - we will use prebuiltui for getting the login form design

import React from 'react'
import { useAppContext } from '../context/AppContext';
import toast from 'react-hot-toast';

// destructuring the setShowLogin prop to close the login form when needed
const Login = () => {
    ...
    const onSubmitHandler = async (event) => {
        ...
        console.log("Submitting form...", state, { name, email, password });
        try {
