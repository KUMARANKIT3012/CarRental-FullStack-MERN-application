...
const AddCar = () => {
  ...
  // State to hold car details and image
  ...
  return (
    <div className='px-4 py-10 md:px-10 flex-1'>
      <Title title="Add New Car" subTitle="Fill in the details to list a new car for booking, including pricing, availability, and more."/>
